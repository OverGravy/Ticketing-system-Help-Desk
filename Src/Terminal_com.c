...
void terminal_print(MessageType type, const char* message, Role role, const char* name) {
    ...
    switch (type) {
        case MSG_INFO: msg_color = MSG_INFO_COLOR; break;
        case MSG_SUCCESS: msg_color = MSG_SUCCESS_COLOR; break;
        case MSG_ERROR: msg_color = MSG_ERROR_COLOR; break;
        default: msg_color = ANSI_RESET; break;
    }
